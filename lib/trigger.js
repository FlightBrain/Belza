...
// A thread the bot is active in still has humans talking to each other.
// If this message @mentions a specific person other than the bot, it's
// addressed to them, not the bot — don't chime in.
export function isAddressedToOtherUser(text, botUserId) {
