...
export function getCapabilities() {
  return {
    ...
    // Hard false. There is no calendar integration and an API key cannot
    // provide one: Google documents API keys as anonymous access to PUBLIC
    // data, and Workspace calendars are not public. This needs per-user OAuth
    // or a service account with domain-wide delegation before it can be true.
