...
// NOTE THE APOSTROPHE CLASS. The first version of this matched only a straight
// quote, so a model reply containing the curly form ("he\u2019s") fell through
// the contraction rule and got caught by the bare he->they rule instead,
// producing "they\u2019s". Found in a live smoke test, not in a unit test,
// because the fixtures were all typed with straight quotes.
const APOS = "['\u2018\u2019\u02BC]";
const PRONOUN_REWRITES = [
  [new RegExp(`\\bhe${APOS}s\\b`, 'gi'), "they're"],
  [new RegExp(`\\bshe${APOS}s\\b`, 'gi'), "they're"],
